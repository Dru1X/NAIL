    ...
    <a href="{{route('competitions.show', $competition)}}">
        <div class="flex flex-1 flex-col p-8">
            ...
            <div class="flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="h-14">
    ...
    <div class="-mt-px flex divide-x divide-gray-200 dark:divide-gray-600">
        ...
        <div class="flex w-0 flex-1">
            <a href="{{route('competitions.edit', $competition)}}"
               class="relative -mr-px inline-flex w-0 flex-1 items-center justify-center gap-x-1 rounded-br-lg border border-transparent py-4 text-sm font-semibold text-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
